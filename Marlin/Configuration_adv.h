 ...
 */
#define HOTEND_IDLE_TIMEOUT // 20210216 enabled -------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define USE_CONTROLLER_FAN // 20210219 enabled to cool stepper motors ---------------------------------------------------------------------------------------------------------------------------------
  ...
  #define CONTROLLERFAN_SPEED_IDLE    96 // (0-255) Idle speed, used when motors are disabled // 20210215 changed from 0 to 96 to have fan running slowly when motors are disabled --------------------
  #define CONTROLLERFAN_IDLE_TIME     60 // (seconds) Extra time to keep the fan running after disabling motors
  #define CONTROLLER_FAN_EDITABLE        // Enable M710 configurable settings // 20210215 enabled feature to control via gcode & menu -----------------------------------------------------------------
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 50 // 20210215 this sets the temperature at which the fan turns on/off ------------------------------------------------------------------------------------------
 ...
 */
//#define Z_STEPPER_AUTO_ALIGN // 20210213 - need to investigate --------------------------------------------------------------------------------------------------------------------------------------
 ...
 */
// #define ADVANCED_PAUSE_FEATURE // 20210219 enabled for filament runout feature - disabled for testing -----------------------------------------------------------------------------------------------------------------------
...
>>>>>>> 5d8727a59c0b6a38e7c2cbd73feec3e76036db44
   ...
   */
  #define MONITOR_DRIVER_STATUS // 20210216 enabled ---------------------------------------------------------------------------------------------------------------------------------------------------
...
//  #define HYBRID_THRESHOLD // 20210216 enabled - was super loud / obnoxious; may need to tune values --------------------------------------------------------------------------------------------------
   ...
   */
  #define TMC_DEBUG // 20210216 enabled ---------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define CUSTOM_MENU_MAIN // 20210213 enabled ---------------------------------------------------------------------------------------------------------------------------------------------------------
#if ENABLED(CUSTOM_MENU_MAIN)
