 ...
 */
  ...
  #error "HOMING_FEEDRATE is now set using the HOMING_SPEED_MM_M array instead."
#elif (defined(HOMING_FEEDRATE_XY) || defined(HOMING_FEEDRATE_Z)) && !defined(HOMING_SPEED_MM_M)
  #error "HOMING_FEEDRATE_XY and HOMING_FEEDRATE_Z are now set using the HOMING_SPEED_MM_M array instead."
