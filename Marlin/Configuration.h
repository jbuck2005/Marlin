...
// :[1,2,3,4,5,6,7,8]
#define NUM_M106_FANS 1 // 20210218 had to reduce from 2 to 1 because with FAN1 set as E0_AUTO there is only 1 fan that can be "controlled" now (FAN3 for parts cooling) ------------------------------
