...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  32.70 // 20210313 - M303 C10 E0 S205 U1 ---------------------------------------------------------------------------------------------------------------------------------------
    #define DEFAULT_Ki   3.20 // 20210313 - M303 C10 E0 S205 U1 ---------------------------------------------------------------------------------------------------------------------------------------
    #define DEFAULT_Kd  83.90 // 20210313 - M303 C10 E0 S205 U1 ---------------------------------------------------------------------------------------------------------------------------------------
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  85.02 // 20210215 - M303 C10 E-1 S60 U1 --------------------------------------------------------------------------------------------------------------------------------------
  #define DEFAULT_bedKi  16.10 // 20210215 - M303 C10 E-1 S60 U1 --------------------------------------------------------------------------------------------------------------------------------------
  #define DEFAULT_bedKd 299.26 // 20210215 - M303 C10 E-1 S60 U1 --------------------------------------------------------------------------------------------------------------------------------------
...
<<<<<<< HEAD
//#define USE_ZMIN_PLUG // 20210213 diabled as nothing is plugged in - may need to re-enable for filament sensing (sensor is plugged into E0 (3v3 GND PE15) - 20210214 disabled again to test ------
=======
#define USE_ZMIN_PLUG
//#define USE_IMIN_PLUG
//#define USE_JMIN_PLUG
//#define USE_KMIN_PLUG
>>>>>>> fa94fc5f355fcd9130a895659b7ac12eba64338c
...
#define X_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. // 20210214 endstop pins are PE15 and GND - tested and works in "normal" mode ---------------------------------
#define Y_MIN_ENDSTOP_INVERTING false // Set to true to invert the logic of the endstop. // 20210214 endstop pins are PE10 and GND - tested and works in "normal" mode ---------------------------------
...
<<<<<<< HEAD
#define Z_MIN_PROBE_ENDSTOP_INVERTING true // Set to true to invert the logic of the probe. // 20210213 set to true; nothing is plugged into Z- -------------------------------------------------------
=======
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.2, 79.6, 394.1, 140.22 } // 20210213 changed from 80, 80, 400, 500 to last computed values -----------------------------------------------------------------
 ...
 */
#define BLTOUCH // 20210214 enabled -------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define XY_PROBE_FEEDRATE (100*60) // 20210227 changed default from 133 to 100 -------------------------------------------------------------------------------------------------------------------------

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (6*60) // 20210227 changed from 4 to 12 ----------------------------------------------------------------------------------------------------------------------------------

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (Z_PROBE_FEEDRATE_FAST / 3) // 20210227 changed from 2 to 3 to respect original ratio (4*60)/2 = 120 thus, (6*60)/3 = 120 ------------------------------------------------
...
<<<<<<< HEAD
#define Z_MAX_POS 470 // 20210215 changed from 200 to 450 ---------------------------------------------------------------------------------------------------------------------------------------------
=======
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 9       // Don't use more than 15 points per axis, implementation limited. // 20210227 changed from 10 to 5 ---------------------------------------------------------------
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
//
#define Z_SAFE_HOMING // 20210214 enabled -------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 */
#define SDSUPPORT // 20210217 enabled - this appears to be for an LCD controller based SDCARD slot ----------------------------------------------------------------------------------------------------
...
// :[1,2,3,4,5,6,7,8]
#define NUM_M106_FANS 3 // 20210219 needs to be defined as exactly 3 so that code will compile, despite only 1 fan intending to be M106 controlled (FAN2) ---------------------------------------------
