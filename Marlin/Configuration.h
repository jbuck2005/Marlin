...
#define CUSTOM_MACHINE_NAME "Dad's Build-o-matic v0.1b" // 20210107 --------------------------------------------------------------------------------------------------
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.87 // 20210107 M303 C10 E0 S205 U1 ----------------------------------------------------------------------------------------------------------
    #define DEFAULT_Ki   2.13 // 20210107 ------------------------------------------------------------------------------------------------------------------------------
    #define DEFAULT_Kd  72.79 // 20210107 ------------------------------------------------------------------------------------------------------------------------------
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 168.97  // 20210107 M303 C10 E-1 S60 U1 -------------------------------------------------------------------------------------------------------
  #define DEFAULT_bedKi 31.46   // 20210107 M303 C10 E-1 S60 U1 -------------------------------------------------------------------------------------------------------
  #define DEFAULT_bedKd 605.03  // 20210107 M303 C10 E-1 S60 U1 -------------------------------------------------------------------------------------------------------
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.20, 80.10, 402.80, 100.20 } // 20210106 esteps ------------------------------------------------------------------------------------------
...
//  #define LEVEL_CORNERS_INSET_LFRB { 2, 30, 50, 10 } // (mm) Left, Front, Right, Back insets // (2,30),(170,210) - changed to 2 to prevent stop-crashing - defaults are 30 ------------
