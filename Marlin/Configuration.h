...
#define CUSTOM_MACHINE_NAME "Replicator v0.5f" // does not appear to work if defined in Version.h -------------------------------------------------------------------------------
...
#define LEVEL_BED_CORNERS                 // 20200911 enabled & is VERY useful for first-leveling ----------------------------------------------------------------------------------
  ...
  #define LEVEL_CORNERS_INSET_LFRB { -5, 30, 50, 10 } // (mm) Left, Front, Right, Back insets // (0,40),(170,210) ------------------------------------------------------------------
