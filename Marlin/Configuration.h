...
#define CUSTOM_MACHINE_NAME "Replicator v0.1.13c" // does not appear to work if defined in Version.h -------------------------------------------------------------------------------
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.49 // 20210109 - M303 C10 E0 S205 U1 ------------------------------------------------------------------------------------------------------------------
    #define DEFAULT_Ki   1.47 // 20210109 ----------------------------------------------------------------------------------------------------------------------------------------
    #define DEFAULT_Kd  78.18 // 20210109 ----------------------------------------------------------------------------------------------------------------------------------------
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 180.15 // 20210109 - M303 C10 E-1 S60 U1 ------------------------------------------------------------------------------------------------------------------
  #define DEFAULT_bedKi 32.96  // 20210109 ----------------------------------------------------------------------------------------------------------------------------------------
  #define DEFAULT_bedKd 658.44 // 20210109 ----------------------------------------------------------------------------------------------------------------------------------------
...
#define Z_PROBE_LOW_POINT          -3 // Farthest distance below the trigger-point to go before stopping  // 20210113 changed to -3 ----------------------------------------------
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 0 // 20210107 changed from default 2 to 0 to disable sound by default -------------------------------------------------------------------------------------------------
