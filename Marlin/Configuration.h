...
#define CUSTOM_MACHINE_NAME "Dad's Build-o-matic v0.1" // 20210105 ----------------------------------------------------------------------------------------------------
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  26.97 // 20210106 M303 C10 E0 S205 U1 ----------------------------------------------------------------------------------------------------------
    #define DEFAULT_Ki   2.53 // 20210106 ------------------------------------------------------------------------------------------------------------------------------
    #define DEFAULT_Kd  71.87 // 20210106 ------------------------------------------------------------------------------------------------------------------------------
  #endif
#endif // PIDTEMP
